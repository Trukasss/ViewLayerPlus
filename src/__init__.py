...
def register():
    icons.register()
    bpy.utils.register_class(props.UFRP_preferences)
    ...
    bpy.utils.register_class(ui.UFRP_MT_comp_menu)
    ...
    bpy.types.NODE_MT_context_menu.append(ui.draw_comp_context)
    bpy.types.TOPBAR_HT_upper_bar.append(ui.draw_manager_topbar)
    bpy.types.OUTLINER_MT_collection.append(ui.draw_outliner_context)
    bpy.types.Scene.ufrp = PointerProperty(type=props.UFRP_properties)


def unregister():
    del bpy.types.Scene.ufrp
    bpy.types.OUTLINER_MT_collection.remove(ui.draw_outliner_context)
    bpy.types.TOPBAR_HT_upper_bar.remove(ui.draw_manager_topbar)
    bpy.types.NODE_MT_context_menu.remove(ui.draw_comp_context)
    ...
    bpy.utils.unregister_class(ui.UFRP_MT_comp_menu)
    ...
    bpy.utils.unregister_class(props.UFRP_preferences)
    icons.unregister()